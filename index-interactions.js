...
function initSavingsCalculator() {
    ...
    const exchangeRates = {
        binance: { original: 0.001, discounted: 0.0006, discount: 40 },
        bybit: { original: 0.001, discounted: 0.00047, discount: 53 },
        okx: { original: 0.001, discounted: 0.0005, discount: 50 },
        mexc: { original: 0.001, discounted: 0.0005, discount: 50 }
    };
